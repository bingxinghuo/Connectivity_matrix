...
def main():
    ...
    # target_image_fname = registration_pipeline_dir + '/data/processDetection/180830-annoatated-bh-1.img'
    ...
    JD = lddmm.transform_data(xJ[0],xJ[1],xJ[2],J,out['Aphi0'],out['Aphi1'],out['Aphi2'],
                    y=xS, # sample points
                    t=xI, # transformation is sampled at these points
                    )
    ...
    registerd.SetSpacing((0.05, 0.05, 0.05))
    registerd.SetOrigin((0,0,0))
    sitk.WriteImage(registerd, registration_pipeline_dir + '/data/deformedTarget/' + BRAINNO + '_atlas_50.img')
    # sitk.WriteImage(registerd, registration_pipeline_dir + '/data/processDetection/180830-annoatated-bh-1-atlas.img')

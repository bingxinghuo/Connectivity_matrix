...
for i=7:length(motorbraininfo)
    ...
    neurondensity=neuronvoxelize(motorbraininfo(i),tissuemaskdir,injdir,savedir,motorbraininfo(i).originresolution*maskscale,maskscale,80,'inject');
